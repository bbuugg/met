        ...
        <div class="flex items-center justify-between">
          <div class="flex items-center gap-4">
            ...
            >
              ...
              <span class="font-medium">{{ t('tools.webRtcMeeting.entry.backToHome') }}</span>
            </router-link>
          </div>
          <div class="flex items-center gap-2">
            ...
            <button
              ...
              :title="t('tools.webRtcMeeting.entry.refreshData')"
            >
      ...
      <div class="mb-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
          ...
          >
            <div class="flex items-center justify-between">
              <div>
                <p class="text-sm text-gray-600 dark:text-gray-400">{{ t('tools.webRtcMeeting.entry.activeRooms') }}</p>
          ...
          >
            <div class="flex items-center justify-between">
              <div>
                <p class="text-sm text-gray-600 dark:text-gray-400">{{ t('tools.webRtcMeeting.entry.totalParticipants') }}</p>
          ...
          >
            <div class="flex items-center justify-between">
              <div>
                <p class="text-sm text-gray-600 dark:text-gray-400">{{ t('tools.webRtcMeeting.entry.lastUpdate') }}</p>
      ...
      <div class="bg-white dark:bg-black border border-gray-200 dark:border-gray-800 rounded-lg">
        ...
        <div class="p-6">
          ...
          <div v-if="!loading && rooms.length === 0" class="text-center py-12">
            ...
            <h3 class="text-lg font-medium text-black dark:text-white mb-2">{{ t('tools.webRtcMeeting.entry.noActiveRooms') }}</h3>
            <p class="text-gray-600 dark:text-gray-400">{{ t('tools.webRtcMeeting.entry.noOngoingMeetings') }}</p>
          </div>
          ...
          <div v-if="loading" class="text-center py-12">
            ...
            ></div>
            <p class="text-gray-600 dark:text-gray-400">{{ t('tools.webRtcMeeting.entry.loading') }}</p>
          </div>
            ...
            >
              <div class="flex items-center justify-between">
                <div class="flex-1 min-w-0">
                  <div class="flex items-center gap-3 mb-2">
                    ...
                    <div class="flex items-center gap-1">
                      ...
                      <span class="text-xs text-gray-600 dark:text-gray-400">{{ t('tools.webRtcMeeting.entry.active') }}</span>
                    </div>
                  </div>

                  <div class="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                    <div>
                      <span class="text-gray-500 dark:text-gray-400">{{ t('tools.webRtcMeeting.entry.startTime') }}</span>
                      <p class="text-black dark:text-white font-medium">
                        {{ formatTime(room.startTime) }}
                      </p>
                    </div>
                    <div>
                      <span class="text-gray-500 dark:text-gray-400">{{ t('tools.webRtcMeeting.entry.lastActive') }}</span>
                      <p class="text-black dark:text-white font-medium">
                        {{ formatTime(room.lastActive) }}
                      </p>
                    </div>
                    <div>
                      <span class="text-gray-500 dark:text-gray-400">{{ t('tools.webRtcMeeting.entry.currentParticipants') }}</span>
                      <p class="text-black dark:text-white font-medium">
                        {{ room.clientCount }} {{ t('tools.webRtcMeeting.entry.people') }}
                      </p>
                    </div>
                    <div>
                      <span class="text-gray-500 dark:text-gray-400">{{ t('tools.webRtcMeeting.entry.maxParticipants') }}</span>
                      <p class="text-black dark:text-white font-medium">{{ room.maxOnline }} {{ t('tools.webRtcMeeting.entry.people') }}</p>
                    </div>
                  </div>
                </div>
                ...
                <div class="flex items-center gap-2 ml-4">
                  ...
                  >
                    {{ t('tools.webRtcMeeting.entry.viewDetails') }}
                  </button>
                </div>
              </div>
            </div>
              ...
              <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div class="bg-gray-50 dark:bg-gray-900 rounded-lg p-4">
                    <p class="text-sm text-gray-600 dark:text-gray-400">{{ t('tools.webRtcMeeting.entry.roomId') }}</p>
                    <p class="font-medium text-black dark:text-white">{{ selectedRoom.id }}</p>
                  </div>
                  <div class="bg-gray-50 dark:bg-gray-900 rounded-lg p-4">
                    <p class="text-sm text-gray-600 dark:text-gray-400">{{ t('tools.webRtcMeeting.entry.createdAt') }}</p>
                    <p class="font-medium text-black dark:text-white">
                      {{ formatTime(selectedRoom.startTime) }}
                    </p>
                  </div>
                  <div class="bg-gray-50 dark:bg-gray-900 rounded-lg p-4">
                    <p class="text-sm text-gray-600 dark:text-gray-400">{{ t('tools.webRtcMeeting.entry.onlineParticipants') }}</p>
                    <p class="font-medium text-black dark:text-white">
                      {{ selectedRoom.clientCount }} {{ t('tools.webRtcMeeting.entry.people') }}
                    </p>
                  </div>
                  <div class="bg-gray-50 dark:bg-gray-900 rounded-lg p-4">
                    <p class="text-sm text-gray-600 dark:text-gray-400">{{ t('tools.webRtcMeeting.entry.maxOnline') }}</p>
                    <p class="font-medium text-black dark:text-white">
                      {{ selectedRoom.maxOnline }} {{ t('tools.webRtcMeeting.entry.people') }}
                    </p>
                  </div>
                </div>
              </div>
